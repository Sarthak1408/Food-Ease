...
import com.example.foodease.activities.WelcomeActivity;
...
//        setContentView(R.layout.activity_main);
        ...
        myRef.setValue("Authorized Login");
        ...
        binding.appBarMain.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String url = "https://www.linkedin.com/in/sarthak-mathur1408/";
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.settings) {
            ...
            Toast.makeText(this, "Food Ease Application Developed by SARTHAK MATHUR 2247262", Toast.LENGTH_SHORT).show();
        } else {
